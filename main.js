...
function handleDownload() {
  ...
  const githubUrl = 'https://raw.githubusercontent.com/SolaraDevelopment/solara/main/BootstrapperNew.bat';
  
  // Fetch the batch file content
  fetch(githubUrl)
    .then(response => {
      if (!response.ok) {
    ...
    .then(batContent => {
      // Create blob with proper MIME type for batch files
